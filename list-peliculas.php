...
<div class="panel panel-default">
    <div class="panel-heading pb-2 pt-2">
        <div class="container">
            <h1 class="mb-0">Listado completo de los PELÍCULAS almacenados. </h1>
        </div>
    </div>
    <div class="panel-body">
        <div class="container">
            <a class="btn btn-primary float-right" href="add-libro.php" role="button">Añadir un nuevo PELÍCULA</a>

            <div class="listado-discos">
				<?php $parser -> imprimePeliculas();?>
            </div>
            <p>
                <br /><hr /><br />
